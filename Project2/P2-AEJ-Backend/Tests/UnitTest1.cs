...
// reportgenerator -reports:"./TestResults/23249cf1-781a-4bc5-ad73-7179a1fa90d0/coverage.cobertura.xml" -targetdir:"coveragereport" -reporttype:Html
    ...
    public void itemTest(){
        Item newItem = new Item(0,"name",50,25,"url");

        newItem._id = 2;
        newItem._name = "newName";
        newItem._balance = 100;
        newItem._unitPrice = 200;
        newItem._url = "fakeUrl";

        Assert.Equal(100, newItem._balance);
        Assert.Equal(200, newItem._unitPrice);
        Assert.Equal("fakeUrl", newItem._url);
    }
